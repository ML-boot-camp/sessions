...
# %%
query = """
SELECT beer_name, review_text, review_overall
FROM table_ratebeer
LIMIT 5
"""
sql(query)
...
# %%
query = """
SELECT COUNT(DISTINCT beer_name) AS "Number of beer names"
FROM table_ratebeer
"""
sql(query)
...
df_ratebeer_stout = (
  ...
  .loc[lambda df: df.beer_style.str.contains("Stout")]
...
(
    df_ratebeer
    .merge(df_reviewers, on="review_profileName", how='inner')
)
